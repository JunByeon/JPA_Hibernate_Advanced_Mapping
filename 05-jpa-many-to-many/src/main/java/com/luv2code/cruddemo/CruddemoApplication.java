...
public class CruddemoApplication {
	...
	private void findCourseAndStudents(AppDAO appDAO) {
		...
		int theId = 10;
		Course tempCourse = appDAO.findCourseAndStudnetsByCourseId(theId);

		System.out.println("Loasded course: " + tempCourse);
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		Course tempCourse = new Course("Pacman - How To Scoure One Million Points");
	...
	private void createInstructor(AppDAO appDAO) {
		...
		Instructor tempInstructor =
				new Instructor("Madhu", "Pated", "madhu@luv2code.com");
